...
//            $menuItem06 = new MenuItemModel('PasscodeGenerieren', 'Passcode generieren', 'todo', array(/* options */), 'iconclasses fa fa-qrcode')
        ...
        $menuItem04->addChild(new MenuItemModel('SpieleListe', 'Liste', 'station_index', array(/* options */), 'iconclasses fa fa-list'));
        $menuItem04->addChild(new MenuItemModel('SpieleNachrichtSchicken', 'Nachricht schicken', 'station_message', array(/* options */), 'iconclasses fa fa-commenting'));
